...
// Is the ratio between ratio of x[0]:y[0] === x[1]:y[1]
// any vector 0 0
function collinearity(x1, y1, x2, y2) {
  //   colinear if either vector is 0, 0
  const zeros =
    (y1 === 0 && y2 === 0) ||
    (x1 === 0 && x2 === 0) ||
    (x1 === 0 && y1 === 0) ||
    (x2 === 0 && y2 === 0);
  //   colinear if co-efficient is the same (or zeroed)
  const colinear = zeros || x1 / x2 === y1 / y2;
  return colinear;
}
